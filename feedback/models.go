...
type Message struct {
	...
	ReceiverID       bson.ObjectId `json:"receiver_id" form:"-" bson:"receiver_id" valid:"Required"`
	ReceiverFullName string        `json:"receiver_fullname" form:"-" bson:"receiver_fullname" valid:"Required"`
	SenderID         bson.ObjectId `json:"receiver_id" form:"-" bson:"receiver_id" valid:"Required"`
